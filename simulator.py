...
import random as rd
    #Ce module va aider a generer deux nombres flottants aléatoires.
from collections import namedtuple
    #Ce module est pour creer les tuples points et cercles.
import sys
    #Sys va lire les arguments donnés par l'utilisateur.
def point(x, y):
    """Crée un objet point."""
...
def interieur_cercle(circle, pointe):
    ...
    if distance(circle[0], pointe) <= circle[1]:
        return True
    return False
